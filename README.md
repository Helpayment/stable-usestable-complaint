# Stable / useStable Complaint Archive
...
### 1. Passport destruction and identity damage
...
Screenshots are stored in [`assets/`](./assets/). They include Stable pricing pages, help center pages, upgrade communications, account closure messages, refund / arbitration-related messages, and billing screenshots.
...
Use the issue template: [Share Your Stable Experience](./.github/ISSUE_TEMPLATE/share-your-stable-experience.md)
